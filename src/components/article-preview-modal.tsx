          ...
          <Dialog.Content asChild>
            ...
            >
              <motion.div
                ...
                className="pointer-events-auto my-auto w-full max-w-[460px] overflow-hidden rounded-[16px] border border-white/70 bg-white p-5 shadow-[0_30px_80px_-30px_rgba(22,16,50,0.55)] sm:w-[92vw] sm:p-6"
              >
