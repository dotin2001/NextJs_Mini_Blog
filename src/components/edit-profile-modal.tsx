      ...
      <AnimatePresence>
        {open ? (
          ...
          <Dialog.Content asChild>
            <motion.div
              className="pointer-events-none fixed inset-0 z-[70] grid place-items-center overflow-y-auto p-3 sm:p-4"
            >
              <motion.div
                ...
                className="pointer-events-auto my-auto w-full max-w-[360px] max-h-[calc(100vh-2rem)] overflow-y-auto rounded-[16px] border border-white/70 bg-white p-5 shadow-[0_30px_80px_-30px_rgba(22,16,50,0.55)] sm:max-w-[380px] sm:p-6"
              >
